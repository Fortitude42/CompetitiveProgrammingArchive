...
//	update(a[i].s, a[i].f - a[i].s, 1);//r - l
	update(a[i].s, -a[i].f + a[i].s, 1);//l - r
...
void solve() {
	...
	for (int i = 1; i <= q; ++i) {
		...
		res[b[i].s] = min(res[b[i].s], get(b[i].f.s, b[i].f.f, 1) + b[i].f.f - b[i].f.s + 1);
		res[b[i].s] = min(res[b[i].s], get(1, b[i].f.s, 2) + b[i].f.f + b[i].f.s + 1);
		res[b[i].s] = min(res[b[i].s], get(1, b[i].f.s, 0) + n - (b[i].f.f + b[i].f.s) + 1);
	}
	...
	for (int i = q; i > 0; --i) {
		...
		res[b[i].s] = min(res[b[i].s], get(b[i].f.s, b[i].f.f, 2) + (n + b[i].f.f + b[i].f.s) + 1);
		res[b[i].s] = min(res[b[i].s], get(b[i].f.f, n, 1) + (n - b[i].f.f + b[i].f.s) + 1);
	}
